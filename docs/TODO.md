...
| ~~`supabase/setup-cli` pinnen~~ | – | ✅ Erledigt 2026-09-21 | Beide Jobs in `.github/workflows/supabase-drift-check.yml` auf `2.67.1` gepinnt (lokal gegen dieses Projekt geprüft, siehe Task-10-Report). Teil der strukturellen Schema-Drift-Prüfung (Task 10) |
