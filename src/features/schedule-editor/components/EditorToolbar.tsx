...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({
  ...
  const toolbarStyle: React.CSSProperties = {
    ...
    gap: spacing.md,
    padding: spacing.md,
    backgroundColor: isEditing ? 'rgba(76, 175, 80, 0.1)' : colors.surface,
  ...
  const modeIndicatorStyle: React.CSSProperties = {
    ...
    backgroundColor: isEditing ? 'rgba(76, 175, 80, 0.2)' : 'transparent',
  ...
  const conflictBadgeStyle = (severity: 'error' | 'warning'): React.CSSProperties => ({
    ...
    padding: `${spacing.xs} ${spacing.sm}`,
    borderRadius: borderRadius.sm,
    backgroundColor: severity === 'error' ? 'rgba(239, 83, 80, 0.15)' : 'rgba(255, 193, 7, 0.15)',
