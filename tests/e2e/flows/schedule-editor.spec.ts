...
// Base tournament config (schedule will be auto-generated by the app)
// NOTE: Must match format from spielplan.spec.ts exactly
const TEST_TOURNAMENT_EDITOR = {
...
// Turnier mit fertigen Spielen für Sperr-Tests (using correct Match structure)
const TOURNAMENT_WITH_RESULTS = {
  ...TEST_TOURNAMENT_EDITOR,
