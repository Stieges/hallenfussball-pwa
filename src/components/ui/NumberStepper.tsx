...
export const NumberStepper: React.FC<NumberStepperProps> = ({
  ...
  const sliderStyle: CSSProperties = {
    ...
    borderRadius: '4px',
    outline: 'none',
    background: `linear-gradient(to right, ${colors.primary} 0%, ${colors.primary} ${((value - min) / (max - min)) * 100}%, ${colors.surfaceLight} ${((value - min) / (max - min)) * 100}%, ${colors.surfaceLight} 100%)`,
    WebkitAppearance: 'none',
