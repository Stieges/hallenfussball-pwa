/**
 * Import Templates - Template data and download functions for ImportDialog
 *
 * Contains JSON and CSV templates for tournament import,
 * plus the download utility function.
 */
